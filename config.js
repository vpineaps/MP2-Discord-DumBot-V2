module.exports = {
  app: {
    botName: `Toxic Chat Records`, //if you want to use a different name i suggest turning off the DumBot command below in enabledCommands. also edit the help description below to your new bots name.
